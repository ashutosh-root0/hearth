  ...
  const Footer: QuartzComponent = ({ displayClass, cfg }: QuartzComponentProps) => {
    ...
    return (
      <footer class={`${displayClass ?? ""}`}>
        ...
        <ul>
          <li>
            <a href="https://github.com/ashutosh-root0/hearth" target="_blank" rel="noopener noreferrer">
              <GithubIcon />
            </a>
          </li>
          <li>
            <a href="https://open.spotify.com/user/31ydiqcrc5rgue3qkp6vcsrllkae?si=fffc1ca28eb24cfc" target="_blank" rel="noopener noreferrer">
              <SpotifyIcon />
            </a>
          </li>
          <li>
            <a href="https://letterboxd.com/zoomiesNdoobies/" target="_blank" rel="noopener noreferrer" >
              <LetterboxdIcon />
            </a>
          </li>
          <li>
        ...
        <p>
          ...
          <a href="https://quartz.jzhao.xyz/" target="_blank" rel="noopener noreferrer" >Quartz v{version}</a> © {year}
        </p>
        <ul>
